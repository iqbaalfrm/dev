        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            ...
            <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul>
                    <li><a href="teknik-otomotif.php">Teknik Kendaraan Ringan</a></li>
                    <li><a href="rekayasa-perangkat-lunak.php">Rekayasa Perangkat Lunak</a></li>
                    <li><a href="desain-komunikasi-visual.php">Desain Komunikasi Visual</a></li>
                    </ul>
                </li>
